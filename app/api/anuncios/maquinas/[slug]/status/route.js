...
// Função para alterar o STATUS de um anúncio de máquina
export async function PATCH(request, { params }) {
    ...
    try {
        ...
        const updatedAnuncio = await prisma.anuncioMaquina.update({
            where: { slug },
            data: { status },
        });
        ...
        console.error("Erro ao alterar status de máquina:", error);
